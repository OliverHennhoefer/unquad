...
class TestEvaluationMetrics(unittest.TestCase):
    ...
    def test_bootstrap_configuration_with_n_b_m(self):
        bc_nbm = BootstrapConfiguration(n=1_000, b=20, m=0.05)
        self.assertEqual(bc_nbm._c, 1_000)
    ...
    def test_bootstrap_configuration_with_n_m_c(self):
        bc_nmc = BootstrapConfiguration(n=1_000, m=0.05, c=10_000)
        self.assertEqual(bc_nmc.b, 200)

    def test_bootstrap_configuration_with_all(self):
        with self.assertRaises(ValueError):
            BootstrapConfiguration(n=1_000, b=20, m=0.05, c=10_000)
